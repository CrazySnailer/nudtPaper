...
\begin{figure}[htp]
\centering
\includegraphics[width=0.8\textwidth]{figure4_2_bak1}
...
\begin{figure}[htp]
\centering
%\includegraphics[height=7.5cm,width=0.7\textwidth]{figure4_semantic_model_bak1}
\includegraphics[height=7.5cm]{figure4_semantic_model_bak1}
\caption{用户语义轨迹描述模型}
...
\begin{figure}[htp]
\centering
\includegraphics[width=0.8\textwidth]{figure4_tra_semantic_model_bak1}
\caption{语义轨迹示意图}
...
\begin{figure}[htp]
\centering
\includegraphics[width=0.8\textwidth]{figure7_1_RSCHD_bak3}
\caption{基于异构感知数据的用户关系强度计算框架图}
\label{fig:7_1}
\end{figure}

\section{基于用户GPS轨迹数据源的关系强度计算方法}
...
\begin{figure}[htp]
\centering
\includegraphics[width=0.8\textwidth]{figure_3_RSCHDwifibluee_bak2}
