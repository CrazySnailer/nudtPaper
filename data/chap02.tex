...
\begin{table}[htb]
  ...
  \label{tab:truthresult}
    \begin{tabular*}{\linewidth}{cp{10cm}}
      ...
      \mbox{$u_{10} $}& \mbox{$<u_{17},u_{7},u_{20},u_{19},u_{13},u_{17},u_{8},u_{12},u_{11},u_{16},u_{21}>$}\\
      \mbox{$u_{11} $}&  \mbox{$<u_{12},u_{5},u_{21},u_{16},u_{16}>$}\\
      \mbox{$u_{12} $}& \mbox{$ <u_{5},u_{21},u_{16},u_{6},u_{16},u_{19}>$}\\
